...
class ProfilePageView(TemplateViewWithMenu, generic_edit.UpdateView):  # TODO: унаследовать UpdateView - https://docs.djangoproject.com/en/3.1/ref/class-based-views/generic-editing/#django.views.generic.edit.UpdateView
    ...
    def get_object(self, queryset=None):
        ...
        self.votes = AdditionUserInfo.objects.filter(author=object)  # TODO: получить список голосов, привязанных к данному пользователю
        self.votings = AdditionUserInfo.objects.filter(user=object)  # TODO: получить список голосований, привязанных к данному пользователю
        self.addition_info.votes_given = len(self.votes_given)  # TODO: Обновить количество отданных голосов на основании длины списка голосов
        self.addition_info.votings_created = len(self.votings.created)  # TODO: Обновить количество созданных голосований на основании длины списка голосований
        return object
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'votes': self.addition_info.votes_given,
            'votings': self.addition_info.votings_created
        })
        return context
